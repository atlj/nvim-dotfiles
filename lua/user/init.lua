...
local config = {
  ...
  plugins = {
    ...
    -- nvim-tree shows hidden files by default
    -- ignore node modules on telescope
    telescope = {
      pickers = {
        find_files = {
  ...
  polish = function()
    ...
    -- Add your own custom filetypes
    -- vim.cmd [[autocmd BufNewFile,BufRead *.xyz set filetype=xyz]]
